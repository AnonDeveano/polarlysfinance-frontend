export const NEBULA_TICKER = 'NEBULA';
export const BOREALIS_TICKER = 'BOREALIS';
export const STARDUST_TICKER = 'STARDUST';
export const NEAR_TICKER = 'NEAR';
export const WNEAR_TICKER = 'WNEAR';
// UPDATE THESE
